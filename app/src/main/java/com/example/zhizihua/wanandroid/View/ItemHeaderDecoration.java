package com.example.zhizihua.wanandroid.View;
...
/**
 * Created by zhizihua on 2019/4/2.
 */

public class ItemHeaderDecoration extends RecyclerView.ItemDecoration {
    private List<NavagationBean.DataBean.TitlesBean> mDatas;
    ...
    public ItemHeaderDecoration(Context context, List<NavagationBean.DataBean.TitlesBean> datas,ArrayList<NavagationBean.DataBean> leftdata) {
        super();
    ...
    public ItemHeaderDecoration setData(List<NavagationBean.DataBean.TitlesBean> mDatas) {
        this.mDatas = mDatas;
        return this;
    }
...
//        String [] province =context.getResources().getStringArray(R.array.province);
        tvTitle.setText(leftdata.get(Integer.parseInt(tag)).getName());
